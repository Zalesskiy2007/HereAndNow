        ...
        <div className="friends-content">
            <div className="div-row-friends friends-header">
                ...
                <div className="requests-button">
                    {!requestsMode ? (
                        <button className={stateFriendsReq.length > 0 ? 'active' : ''} onClick={() => {                            
                            setRequestsMode((m) => !m)}
                            }>
                            Requests
                        </button>
                                      ...
                                      (user) =>
                                          (
                                            <li key={user.id}>
                                                ...
                                                {user.login}                                                  
                                                <button onClick={() => { handleRemoveFriend(user.id); }} style={{ backgroundColor: 'rgb(210, 30, 20)' }} >
                                                    Remove
                                                </button>                                                
                                            </li>
                                          )
                                            ...
                                            <li key={user.id}>
                                                <img src={user.imageSrc} />
                                                {user.login}                                                  
                                                <button onClick={() => { handleRemoveFriend(user.id); }} style={{ backgroundColor: 'rgb(100, 100, 100)' }} >
                                                    Cancel
                                                </button>                                                
                                            </li>
                                          ))]                                                               
